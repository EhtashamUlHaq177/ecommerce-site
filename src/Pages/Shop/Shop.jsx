...
import ArrowRightNav from '../../assets/svgs/ArrowrightNav.svg'; // Import SVG
import SortArrow from '../../assets/svgs/2.svg'; // Import SVG
...
function Shop() {
  ...
  const appliedFilters = [
    ...
    priceRange.min !== 0 || priceRange.max !== 180
      ? { type: 'Price', value: `${priceRange.min} - ${priceRange.max}` }
      : null,
  ].filter((f) => f);
  ...
  return (
    <div className="Shop">
      <div className="ShopNav">
        ...
        <img className="ArrowNav" src={ArrowRightNav} alt="Arrow" />
                  ...
                  <div className="price-slider">
                    <div className="slider-container">
                      ...
                      <input 
                        ...
                        className="slider max-slider transparent"
                      />
                    </div>
            ...
            <div className="FilterModal">
              <div className="FilterModalContent">
                ...
                <div className="FilterSection">
                  ...
                  {sortByOpen && (
                    <div className="FilterOptions">
                      <div onClick={() => { setSelectedSort('Recommended'); setSortByOpen(false); }}>
                        Recommended
                      </div>
                      <div onClick={() => { setSelectedSort('Newest'); setSortByOpen(false); }}>
                        Newest
                      </div>
                      <div onClick={() => { setSelectedSort('Price (low to high)'); setSortByOpen(false); }}>
                        Price (low to high)
                      </div>
                      <div onClick={() => { setSelectedSort('Price (high to low)'); setSortByOpen(false); }}>
                        Price (high to low)
                      </div>
                      <div onClick={() => { setSelectedSort('Name A-Z'); setSortByOpen(false); }}>
                        Name A-Z
                      </div>
                      <div onClick={() => { setSelectedSort('Name Z-A'); setSortByOpen(false); }}>
                        Name Z-A
                      </div>
                    </div>
                  )}
                  ...
                  <span
                    onClick={() => {
                      if (filter.type === 'Color')
                        setSelectedColors(selectedColors.filter((c) => c !== filter.value));
                      if (filter.type === 'Size')
                        setSelectedSizes(selectedSizes.filter((s) => s !== filter.value));
